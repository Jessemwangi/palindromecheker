...
class Main extends Component {
  ...
  SubmitHandler = (e) => {
    ...
    return (
      <div>
        <span>{this.state.ispalindrom}</span>
      </div>
    );
  };
  render() {
    ...
    return (
      <div>
        <main>
          <Form
            palindrom={this.state.palindrom}
            send={(e) => this.SubmitHandler(e)}
            valuechange={valuechange}
          />
          <hr />
          <div>
            {this.state.palindrom}: : is palindrome ?.
            <div
              className={
                this.state.ispalindrom === true
                  ? this.state.cssforresult + " ispalindrom"
